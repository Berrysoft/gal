        ...
        while (this._currentRemainTime >= physicsDeltaTime) {
            ...
            for (var settingIndex = 0; settingIndex < this._physicsRig.subRigCount; ++settingIndex) {
                ...
                for (var i = 0; i < currentSetting.outputCount; ++i) {
                    ...
                    var outParameterCache = !Float32Array.prototype.slice &&
                    ...
                    // 値を反映
                    for (var offset = destinationParameterIndex, outParamIndex = 0; offset < this._parameterCache.length; offset++, outParamIndex++) {
